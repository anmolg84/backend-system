...
/**
    ...
    * How to create Threads?
        ...
        * Implements Runnable Interface and then pass it to thread constructor (Better Option as java allows multiple implements but single extend)
            ...
            * Callable<T>: Similar to Runnable, but its call() method is used
                * Consumed By Executor service, method can return a result of type T and can throw checked exceptions.
    ...
    * Deadlock in MultiThreading: Two or more threads blocked indefinable , each waiting other to release resource
...
public class Threads {
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        // Callable<T> & Future<T> using Executor Service
